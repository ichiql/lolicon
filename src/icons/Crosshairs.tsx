...
export function CrosshairsIcon({ size, className }: IconProps) {
  return (
    <Icon
      label='Crosshairs'
      size={size}
      ...
      children={
        <g>
          ...
          <path d='M16 11c-.552 0-1-.392-1-.875v-5.25c0-.483.448-.875 1-.875s1 .392 1 .875v5.25c0 .483-.448.875-1 .875zM16 28c-.552 0-1-.392-1-.875v-5.25c0-.483.448-.875 1-.875s1 .392 1 .875v5.25c0 .483-.448.875-1 .875zM11 16c0 .552-.392 1-.875 1h-5.25C4.392 17 4 16.552 4 16s.392-1 .875-1h5.25c.483 0 .875.448.875 1zM28 16c0 .552-.392 1-.875 1h-5.25c-.483 0-.875-.448-.875-1s.392-1 .875-1h5.25c.483 0 .875.448.875 1z' />
        </g>
      }
    />
  )
