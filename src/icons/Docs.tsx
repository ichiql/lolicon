...
export function DocsIcon({ size, className }: IconProps) {
  return (
    <Icon
      label='Docs'
      size={size}
      ...
      children={
        <g>
          ...
          <path d='M9.5 11a1 1 0 0 1 1-1h11a1 1 0 0 1 0 2h-11a1 1 0 0 1-1-1zM9.5 16a1 1 0 0 1 1-1h11a1 1 0 0 1 0 2h-11a1 1 0 0 1-1-1zM9.5 21a1 1 0 0 1 1-1h8a1 1 0 0 1 0 2h-8a1 1 0 0 1-1-1z' />
        </g>
      }
    />
  )
