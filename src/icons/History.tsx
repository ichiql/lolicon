...
export function HistoryIcon({ size, className }: IconProps) {
  return (
    <Icon
      ...
      children={
        <g>
          <path d='M26 16c0 5.523-4.477 10-10 10-4.16 0-7.726-2.54-9.233-6.153l-1.847.77C6.73 24.952 11.008 28 16 28c6.627 0 12-5.373 12-12S22.627 4 16 4 4 9.373 4 16h2c0-5.523 4.477-10 10-10s10 4.477 10 10z' />
