...
export function BankIcon({ size, className }: IconProps) {
  return (
    <Icon
      label='Bank'
      size={size}
      ...
      children={
        <g>
          ...
          <path d='M16 22a1 1 0 0 1-1-1v-7a1 1 0 0 1 2 0v7a1 1 0 0 1-1 1zM21 22a1 1 0 0 1-1-1v-7a1 1 0 0 1 2 0v7a1 1 0 0 1-1 1zM11 22a1 1 0 0 1-1-1v-7a1 1 0 0 1 2 0v7a1 1 0 0 1-1 1z' />
        </g>
      }
    />
  )
